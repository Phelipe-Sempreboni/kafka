...
Método Manual: As pastas podem ser criadas manualmente com os nomes abaixo. 
...
Método pelo Prompt de comando: Abrir o Prompt de comando e executar os seguintes comandos (pressione WIN + R, escreva cmd e aperte enter).
